          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold gradient-text" data-testid="stat-total-datasets">{stats.total}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold gradient-text" data-testid="stat-total-examples">{stats.totalExamples.toLocaleString()}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold gradient-text" data-testid="stat-total-size">{formatFileSize(stats.totalSize)}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold gradient-text" data-testid="stat-kb-generated">{stats.autoGenerated}</p>
              </div>
