  ...
  private async generateWorkerNotebook(
    ...
    const workerCell: NotebookCell = {
      ...
      source: [
        ...
        'heartbeat_counter = 0\n',
        'failed_heartbeats = 0\n',
        'MAX_FAILED_HEARTBEATS = 3  # Shutdown after 3 consecutive failures\n',
        '\n',
        'print("💡 [INFO] Auto-shutdown enabled:")\n',
        'print("   - Backend can send shutdown signal via heartbeat")\n',
        ...
        '                print("\\n🛑 Graceful shutdown initiated - exiting kernel...")\n',
        '                sys.exit(0)  # ✅ Kaggle will terminate the container\n',
        '            \n',
        ...
        '                \n',
        '                # Auto-shutdown after consecutive failures\n',
        '                if failed_heartbeats >= MAX_FAILED_HEARTBEATS:\n',
        '                    print(f"\\n❌ Backend offline for {failed_heartbeats * 30}s - shutting down to preserve quota")\n',
        '                    sys.exit(0)\n',
        '        \n',
        '        time.sleep(1)\n',
        '        heartbeat_counter += 1\n',
