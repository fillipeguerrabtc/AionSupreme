  ...
  private async generateWorkerNotebook(
    ...
    const workerCell: NotebookCell = {
      ...
      source: [
        ...
        '    # Use TinyLlama (< 600MB) instead of Llama-3.2-1B (~4GB)\n',
        '    model_name = job.get("modelName", "TinyLlama/TinyLlama-1.1B-Chat-v1.0")\n',
        ...
        '        \n',
        '        # Step 2: Load base model + LoRA config (with error handling)\n',
        '        print("\\n🔧 [STEP 2/6] Loading model + LoRA config...")\n',
        '        try:\n',
        '            from transformers import AutoModelForCausalLM, AutoTokenizer, BitsAndBytesConfig\n',
        '            from peft import LoraConfig, get_peft_model, prepare_model_for_kbit_training\n',
        '            import torch\n',
        '        except ImportError as e:\n',
        '            raise Exception(f"Missing dependencies: {e}. Run setup cell first!")\n',
        '        \n',
        '        # Use 4-bit quantization to reduce memory (50% smaller)\n',
        ...
        '        print("\\n📋 [STEP 3/6] Preparing dataset for Trainer...")\n',
        '        from datasets import Dataset\n',
        '        \n',
        '        # Format examples for causal LM training\n',
        '        def format_example(example):\n',
        '            # Assume examples have "input" and "output" fields\n',
        '            input_text = example.get("input", "")\n',
        '            output_text = example.get("output", "")\n',
        '            return {"text": f"[INST] {input_text} [/INST] {output_text}"}\n',
        '        \n',
        '        formatted_data = [format_example(ex) for ex in dataset_data["examples"]]\n',
        ...
        '        print("\\n🔥 [STEP 4/6] Training LoRA adapters...")\n',
        ...
        '        print("\\n💾 [STEP 5/6] Saving LoRA adapters...")\n',
        '        lora_save_path = "/kaggle/working/lora_adapters"\n',
        '        model.save_pretrained(lora_save_path)\n',
        '        tokenizer.save_pretrained(lora_save_path)\n',
        '        print(f"✅ LoRA adapters saved to {lora_save_path}")\n',
        '        \n',
        '        # Step 6: Upload model to backend (simplified)\n',
        '        print("\\n📤 [STEP 6/6] Uploading trained model...")\n',
        '        # TODO: Implement proper upload via multipart form or S3\n',
        '        print("⚠️ Model upload not implemented - would upload adapter files")\n',
        '        \n',
        '        # Report success with real metrics\n',
        '        metrics = {\n',
        '            "loss": float(train_result.training_loss),\n',
        '            "trainable_params": model.num_parameters(),\n',
        '            "epochs": 1,\n',
        '            "examples_trained": len(tokenized_dataset),\n',
        '            "adapter_path": lora_save_path\n',
        '        }\n',
        '        \n',
        '        requests.post(\n',
