...
export interface PriorityRequest {
  ...
  forceProvider?: 'groq' | 'gemini' | 'openrouter';  // ✅ ENTERPRISE: Force specific FREE API provider (OpenAI is STEP 5 only)
...
async function executeWebFallback(
  ...
  options: {
    ...
    forceProvider?: 'groq' | 'gemini' | 'openrouter';  // ✅ ENTERPRISE: Force specific FREE provider (OpenAI is STEP 5 only)
  } = {}
